  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {rolDeliveryAprobado && (<><View style={styles.card}><Text style={styles.seccionTitulo}>Rol Delivery aceptado</Text><Text style={styles.infoDescripcion}>Tu solicitud fue aprobada. Ya puedes trabajar como Delivery.</Text></View></>)}{!rolDeliveryAprobado && (
          <>
