  ...
  return (
    <>
      ...
      <View style={styles.container}>
        ...
        {/* ================= ADMIN + CARRITO ================= */}
        <View style={styles.carritoColumna}>
          ...
          {esAdministrador && (
            <TouchableOpacity
              ...
              activeOpacity={0.8}
              onPress={() => router.push("/administrador" as any)}
            >
              <MaterialCommunityIcons
                ...
                color="#FFFFFF"
              />
              <Text style={styles.botonAdministradorTexto}>
                ADMIN
              </Text>
            </TouchableOpacity>
          )}
